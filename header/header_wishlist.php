<li class="iscart ishover">
    <a href="../wishlist/wishlist.php">
        ...
        if (isset($_SESSION['email'])) {
            ...
            // Prepare and execute SQL query to count rows in the wishlist for the user
            $stmt = $conn->prepare("SELECT COUNT(*) AS total_rows FROM wishlist WHERE email = ?");
        ...
        <div class="content">
            <div class="cart-body">
                <ul class="products mini">
                    ...
                    <?php include '../wishlist/getwishhover.php'; ?>
                </ul>
            </div>
        </div>
    </div>
