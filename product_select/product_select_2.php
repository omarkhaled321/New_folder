...
$product_ids = array(4, 5, 6); // Example IDs
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<a href='./productview.php?id=" . $row["id"] . "&price=" . $row["price"] . "&oprice=" . $row["oprice"] . "&discount=" . $row["discount"] . "&name=" . urlencode($row["name"]) . "&image=" . urlencode($row["image"]) . "'>";
        ...
        echo "<li><a href='./productview.php?id=" . $row["id"] . "&price=" . $row["price"] . "&oprice=" . $row["oprice"] . "&discount=" . $row["discount"] . "&name=" . urlencode($row["name"]) . "&image=" . urlencode($row["image"]) . "'><i class='ri-eye-line'></i></a></li>";
